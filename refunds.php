...
<body>
  ...
  <main class="content-shift p-4">
    <div class="container-fluid rounded-4 p-4 text-white" style="background: rgba(15, 23, 42, 0.6) !important; border: 1px solid rgba(148, 163, 184, 0.2) !important; box-shadow: 0 10px 30px rgba(0,0,0,.25);">
      ...
      <div id="dragScrollRefundsContainer" class="table-responsive rounded-3" style="border: none !important; background: transparent !important;">
        <table class="table table-hover align-middle mb-0 text-white-element" style="background: transparent !important; color: #e5e7eb !important; min-width: 980px; user-select: none; border-collapse: collapse !important;">
          ...
          <tbody style="background: transparent !important;">
            ...
            <?php else: ?>
              <tr>
                <td colspan="7" class="text-center py-5 text-muted italic" style="background: transparent !important; border: none !important;">Belum ada data refund.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
  ...
  <script>
    function openTambahRefund() {
      ...
      if (form) form.reset();
      document.getElementById('refund-action').value = 'create';
      // default status PENDING sudah di select
    }
  </script>
