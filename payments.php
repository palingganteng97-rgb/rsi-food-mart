...
<head>
  ...
  <style>
    ...
    #dragScrollPaymentsContainer table { border-collapse: collapse !important; border: none !important; }
    #dragScrollPaymentsContainer table th, #dragScrollPaymentsContainer table td { border-left: none !important; border-right: none !important; border-bottom: 1px solid rgba(148, 163, 184, 0.12) !important; }
  ...
  <main class="content-shift p-4">
    <div class="container-fluid rounded-4 p-4 text-white" style="background: rgba(15, 23, 42, 0.6) !important; border: 1px solid rgba(148, 163, 184, 0.2) !important; box-shadow: 0 10px 30px rgba(0,0,0,.25);">
      ...
      <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4 pb-3" style="border-bottom: 1px solid rgba(148, 163, 184, 0.15) !important;">
        ...
        <div>
          <!-- tidak ada tombol tambah karena payments hanya update status via form/aksi -->
        </div>
      </div>
      ...
      <?php if (!empty($msg_status)): ?>
        <div class="alert <?= strpos($msg_status, 'success') !== false ? 'alert-success' : 'alert-danger'; ?> alert-dismissible fade show mb-4" role="alert" style="background-color: #1e1e24; color: #fff; border-color: #2d2d34;">
          <strong>
            <?php 
              if ($msg_status === 'success_create' || $msg_status === 'success_update') echo "Operasi pembayaran berhasil!";
      ...
      <form method="GET" class="mb-4" style="max-width: 920px;">
        <div class="row g-2 align-items-end">
          <div class="col-12 col-md-6">
            ...
            <input type="text" name="search" value="<?= htmlspecialchars($search ?? '') ?>" class="form-control rounded-3" placeholder="Contoh: INV-2024... atau transaksi..." style="background: rgba(2, 6, 23, 0.4) !important; border: 1px solid rgba(148, 163, 184, 0.25) !important; color: #e5e7eb !important;" />
          </div>
      ...
      <div id="dragScrollPaymentsContainer" class="table-responsive rounded-3" style="border: none !important; background: transparent !important;">
        <table class="table table-hover align-middle mb-0 text-white-element" style="background: transparent !important; color: #e5e7eb !important; min-width: 900px; user-select: none; border-collapse: collapse !important;">
          <thead class="text-uppercase" style="font-size: 0.8rem; font-weight: 700; color: #94a3b8 !important; background-color: rgba(15, 23, 42, 0.8) !important; border-bottom: 1px solid rgba(148, 163, 184, 0.25) !important;">
            <tr>
              ...
              <th class="py-3 text-white" style="background: transparent !important; border: none !important; width: 200px;">Order</th>
              <th class="py-3 text-white" style="background: transparent !important; border: none !important; width: 240px;">Transaction</th>
              <th class="py-3 text-white" style="background: transparent !important; border: none !important; width: 220px;">Method</th>
          ...
          <tbody style="background: transparent !important;">
            <?php if (!empty($payments)): ?>
              <?php foreach ($payments as $row): ?>
                ...
                <tr style="background: transparent !important; font-size: 0.88rem;">
                  ...
                  <td class="text-white-50" style="background: transparent !important; border: none !important;"><?= htmlspecialchars($methodLabel !== '' ? $methodLabel : '-') ?></td>
                  <td class="text-center" style="background: transparent !important; border: none !important;"><?= $badgeHtml ?></td>
                  <td class="text-center" style="background: transparent !important; border: none !important;">
                    <form method="POST" action="payments.php?action=update_status" class="d-flex flex-column flex-md-row gap-2 justify-content-center align-items-center" style="pointer-events:auto;">
            ...
            <?php else: ?>
              <tr>
                <td colspan="6" class="text-center py-5 text-muted italic" style="background: transparent !important; border: none !important;">Belum ada data pembayaran.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
